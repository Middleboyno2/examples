import 'package:caccu_app/data/entity/billEntity.dart';
...
class EditBillScreen extends StatefulWidget {
  ...
  EditBillScreen({super.key, required this.billEntity});
...
class _EditBillScreenState extends State<EditBillScreen> {
  ...
  void initState() {
    ...
    selectedCateId = widget.billEntity.categoryId.id;
    amountController = TextEditingController(text: widget.billEntity.price.toString());
    nameController = TextEditingController(text: widget.billEntity.name ?? '');
    selectedDate = widget.billEntity.deadline;
    isActive = widget.billEntity.repeat;
  }

  void _update(BuildContext context, String billId) async {
    ...
    await BillViewModel().updateBill(billId, selectedCateId!, nameController.text, double.tryParse(amountController.text)!, selectedDate!, isActive);
                    ...
                    children: [
                      ...
                      Center(
                        child: ElevatedButton(
                          onPressed: () {
                            _update(context, widget.billEntity.billId!);
                          },
